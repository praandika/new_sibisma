        ...
        <div class="wrapper sidebar_minimize">
            ...
            <div class="main-panel">
			    <div class="content">
                    ...
                    @if(Route::is('entry.*') || Route::is('allocation.index')) 
                        bg-info-gradient 
                    @elseif(Route::is('sale.*') || Route::is('stock.onhand'))
                        bg-success-gradient 
                    @elseif(Route::is('out.*') || Route::is('allocation.out')) 
                        bg-danger-gradient

    ...
    <body>
        <div class="wrapper sidebar_minimize">
            ...
            <div class="main-panel">
			    <div class="content">
                    <div class="panel-header @if(Route::is('entry.*') || Route::is('allocation.index')) bg-info-gradient @elseif(Route::is('sale.*')) bg-success-gradient @elseif(Route::is('out.*') || Route::is('allocation.out')) bg-danger-gradient @elseif(Route::is('stock.*')) bg-secondary-gradient @else bg-primary-gradient @endif text-white bubble-shadow">

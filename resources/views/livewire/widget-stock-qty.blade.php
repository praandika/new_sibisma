...
@endpush
<span class="widget-stock" id="widgetStock" data-toggle="modal" data-target=".modalWidget"><p style="font-size: 10px; cursor:pointer;">Stocks <br> <strong style="font-size: 22px;">{{ number_format($stock,0) }}</strong></p></span>

        ...
        <div class="card-body">
            ...
            <table>
                @foreach($sentral as $o)
                    <tr>
                        <td><span style="width: 3px; display: inline-block; background-color: <?php echo $o->unit->color->color_code ?>;"></span> {{ $o->qty }} | {{ $o->unit->model_name }} | {{ $o->unit->color->color_name }} | {{ $o->unit->year_mc }}</td>
                    </tr>
                @endforeach
            </table>
        </div>

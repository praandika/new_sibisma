...
@endpush
<div class="modal fade modalChangeStock" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
...
<script>
    ...
    {
        $.ajax({
            url: "{{ route('spk.datastockrequest') }}",
            type: 'GET',
            data: {
    ...
    $('.modalChangeStock').on('shown.bs.modal', function () {
        loadStockModal(1);
    });

...
@section('title','Branch Delivery History')
@section('page-title','Branch Delivery History')

@push('link-bread')
<li class="nav-item">
    <a href="{{ route('branch-delivery.index') }}">Data Branch Delivery History</a>
</li>
<li class="separator">
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Branch Delivery History Data</h4>
        </div>
        <div class="card-body">

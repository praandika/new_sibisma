@push('button')
@section('button-title','Add New Type Activity')
...
<div class="col-md-12" id="dataCreate" @if(Session::has('display')) style="display: block;" @else style="display: none;"
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-10">
                    <h4 class="card-title">Add New Type Activity</h4>
                </div>
                <div class="col-2">
        ...
        <div class="card-body">
            <form action="{{ route('acttype.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-floating-label">
                            <input id="type_activity" type="text" class="form-control input-border-bottom" name="type_activity" value="{{ old('type_activity') }}" required>
